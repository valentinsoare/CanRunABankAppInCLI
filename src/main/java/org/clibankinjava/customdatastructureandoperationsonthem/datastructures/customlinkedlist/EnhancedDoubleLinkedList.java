package org.clibankinjava.customdatastructureandoperationsonthem.datastructures.customlinkedlist;

import lombok.Getter;
import lombok.NoArgsConstructor;
import lombok.Setter;
import org.clibankinjava.customdatastructureandoperationsonthem.datastructures.GenericComparator;
...
@Setter
@NoArgsConstructor
public class EnhancedDoubleLinkedList<E extends Comparable<E>> extends AbstractList<E> implements Iterable<E> {
    private int size;

    private Node<E> head;
    private Node<E> tail;

    public EnhancedDoubleLinkedList(E e) {
        this.head = this.tail = new Node<>(e);
        this.size++;
    }

    public EnhancedDoubleLinkedList(Collection<? extends E> c) {
        this();
        addAllIAtTheBack(c);
    }

    public EnhancedDoubleLinkedList(EnhancedDoubleLinkedList<E> enhancedDoubleLinkedList) {
        this();
    ...
    public int searchForEmployeeAndReturnedIndex(E e) {
    ...
    public boolean addBefore(E newE, E oldE) {
        int indexAfterSearch = searchForEmployeeAndReturnedIndex(oldE);
    ...
    public void insertElementInSortedOrder(E e) {
        if (size == 0) {
            ...
            if (e.compareTo(head.getItem()) < 0) {
                ...
                // add the last element to tail if it is needed
    ...
    public void customSortingInAscendingOrder() {
        EnhancedDoubleLinkedList<E> unsortedOriginal = getANewInstanceOf(this);
        this.clearTheList();
    ...
    public String toString() {
        ...
        EnhancedListIterator iter = new EnhancedListIterator();
